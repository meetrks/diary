    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_number', models.CharField(db_index=True, max_length=15, unique=True, verbose_name='Mobile No.')),
                ('name', models.CharField(max_length=100, verbose_name='Name')),
                ('is_staff', models.BooleanField(default=False, verbose_name='Dashboard Access Status')),
